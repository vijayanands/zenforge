...
def main():
    if len(sys.argv) < 4:
        print(
            "Usage: python fetch_commit_comments.py <owner> <repo> <start_date> [end_date] [token]"
        )
        print(
            "Example: python fetch_commit_comments.py octocat Spoon-Knife 2021-01-01T00:00:00Z"
        )
        sys.exit(1)
