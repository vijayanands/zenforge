...
def main():
    if len(sys.argv) < 4:
        print("Usage: python fetch_commits.py <owner> <repo> <start_date> [end_date] [token]")
        print("Example: python fetch_commits.py octocat Spoon-Knife 2021-01-01T00:00:00Z")
        sys.exit(1)
